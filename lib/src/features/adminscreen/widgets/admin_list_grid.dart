...
import 'package:adopt_v2/src/features/adminscreen/widgets/animal_details_admin.dart';
...
class AdminListGrid extends StatefulWidget {
  ...
  @override
  _AdminListGridState createState() => _AdminListGridState();
}

class _AdminListGridState extends State<AdminListGrid> {
  ...
  @override
  void didUpdateWidget(AdminListGrid oldWidget) {
  ...
  void _navigateToUserAnimalDetails(String animalId) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => AnimalDetailsAdminPage(animalId: animalId)),
    );
  }
