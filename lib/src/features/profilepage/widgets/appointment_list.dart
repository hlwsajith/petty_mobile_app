...
import 'package:adopt_v2/src/features/profilepage/widgets/appointment_user_previewScreen.dart';
...
class _AppointmentListState extends State<AppointmentList> {
  ...
  Future<void> _fetchAppointments() async {
    final fetchedData = await _appointmentRepository.fetchUserAppointments(widget.username);
                              ...
                              ElevatedButton.icon(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => AppointmentUserPreviewScreen(appointmentId: appointments.appointmentId),
                                    ),
                                  );
                                },
