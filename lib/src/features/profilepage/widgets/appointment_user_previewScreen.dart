...
class AppointmentUserPreviewScreen extends StatefulWidget {
  final String appointmentId;

  AppointmentUserPreviewScreen({
    required this.appointmentId,
  });

  @override
  _AppointmentUserPreviewScreenState createState() =>
      _AppointmentUserPreviewScreenState();
}

class _AppointmentUserPreviewScreenState extends State<AppointmentUserPreviewScreen> {
  ...
  Widget build(BuildContext context) {
    if (appointment == null) {
      ...
      } else if (appointment!.appointmentStatus == 'Incoming') {
        statusWidget = Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(
