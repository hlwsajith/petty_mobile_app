...
class AnimalDetailsUserPage extends StatefulWidget {
  final String animalId;

  const AnimalDetailsUserPage({required this.animalId});

  @override
  _AnimalDetailsUserPageState createState() => _AnimalDetailsUserPageState();
}

class _AnimalDetailsUserPageState extends State<AnimalDetailsUserPage> {
  Animal? animal;
