...
class IncomingCard extends StatefulWidget {
  @override
  _IncomingCardState createState() => _IncomingCardState();
}
class _IncomingCardState extends State<IncomingCard> {
  ...
  Future<void> _fetchAppointments() async {
    final fetchedData = await _appointmentRepository.fetchIncomingAppointments(vetname,'Completed');
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Icon(
                        Icons.check_circle,
                        color: Colors.green, // Status icon color
                      ),
                    ],
                  ),
                  SizedBox(height: 16),
