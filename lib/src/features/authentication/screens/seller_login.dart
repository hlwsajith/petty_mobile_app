...
import 'package:adopt_v2/src/features/authentication/screens/seller_signup.dart';
...
class _SellerLoginState extends State<SellerLogin> {
  ...
  Future<void> _login(BuildContext context) async {
    try {
      final String sellername = sellernameController.text;
      ...
      String token = (await backendService.loginSeller(sellername, password)) as String;
      if (token.isNotEmpty) {
        // Store the token in secure storage (e.g., Flutter Secure Storage)
        await storage.write(key: 'auth_token', value: token);
        await storage.write(key: 'sellername', value: sellername);
        await storage.write(key: 'usertype', value: 'seller');
